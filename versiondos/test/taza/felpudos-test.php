...
generarImagenConTexto($textoCliente, 3019, 216, '404-1611085-8049937_31623836999242/con_texto.png');
...
$imagen_Base->compositeImage($Texto_Cliente, Imagick::COMPOSITE_OVER, 767, 1200);
...
$imagen_Base->writeImage('404-1611085-8049937_31623836999242/Felpudo_final_sin_texto.png');
...
function generarImagenConTexto($texto, $anchoArea, $altoArea, $rutaGuardado)
{
    ...
    // Calcular la posición vertical para que empiece desde la parte superior
    $posicionVertical = $boundingBox['ascender'];
