    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_FILES['excelFile']) && $_FILES['excelFile']['error'] == UPLOAD_ERR_OK) {
            ...
            if ($fileExtension == 'xlsx') {
                ...
                echo '<table border="1">';
                echo '<tr><th>Seleccionar</th><th>Order Item ID</th><th>SKU</th><th>Nombre del Producto</th><th>Customidez URL</th></tr>';
                foreach ($data as $row) {
                    echo '<tr>';
                    ...
                    // Añadir botón de descarga si existe la URL
                    if (isset($row[24])) {
                ...
                echo '</table>';
                echo '<input type="submit" name="downloadSelected" value="Descargar Seleccionados">';
                echo '</form>';
            } else {
                echo '<h3>El archivo subido no es un .xlsx válido.</h3>';
            }
        } elseif (isset($_POST['downloadSelected']) && !empty($_POST['urls'])) {
            $urls = $_POST['urls'];
            ...
            // Obtener las URLs de la tabla temporal
