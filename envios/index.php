...
<body>
    ...
    <footer class="footer mt-auto py-3 bg-light fixed-bottom">
        <div class="container">
            ...
            <button type="submit" name="opcion" id="envios" value="envios" class="btn btn-danger float-end m-1"><i class="bi bi-truck"></i> Generar Envios</button>
            <button type="submit" name="opcion" id="facturas"  value="facturas" class="btn btn-success float-end m-1"><i class="bi bi-receipt-cutoff"></i> Obtener Facturas</button>
        </form>
        </div>
    </footer>
